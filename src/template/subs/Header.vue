    ...
    <div>
        <div id="kt_header" class="kt-header kt-grid__item  kt-header--fixed ">
            ...
            <div class="kt-header-menu-wrapper" id="kt_header_menu_wrapper">
                ...
                <div id="kt_header_menu"
                    ...
                    <ul class="kt-menu__nav ">
                        ...
                        <!--                                    <li class="kt-menu__item " aria-haspopup="true"><a href="demo1/index.html"-->
            ...
            <div class="kt-header__topbar">
                ...
                <!--                        <form>-->
                <!--                            &lt;!&ndash;begin: Head &ndash;&gt;-->
                <!--                            <div class="kt-head kt-head&#45;&#45;skin-dark"-->
                <!--                                 style="background-image: url(Modules/Base/assets/media/misc/bg-1.jpg)">-->
                ...
                <!--                                </h3>-->
                <!--                            </div>-->
                <!--                            &lt;!&ndash;end: Head &ndash;&gt;-->

                <!--                            &lt;!&ndash;begin: Grid Nav &ndash;&gt;-->
                ...
                <div class="kt-header__topbar-item kt-header__topbar-item--user">
                    <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
                        <div class="kt-header__topbar-user">
                            ...
                            <span class="kt-header__topbar-username kt-hidden-mobile">{{ user_full_name }}</span>
                    ...
                    <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
                        ...
                        <!--                                <img class="kt-hidden" alt="Pic" src="@/assets/media/users/300_25.jpg"/>-->
                        <!--                                &lt;!&ndash;use below badge element instead the user avatar to display username's first letter(remove kt-hidden class to display it) &ndash;&gt;-->
                        ...
                        <div class="kt-notification">
                            ...
                            <router-link :to="{name: 'company.config', params : {lang:$i18n.locale}}"
                                         class="kt-notification__item" v-if="isAuthorized">
                                <div class="kt-notification__item-icon">
                            ...
                            <div class="kt-notification__custom kt-space-between">
                                <a target="_blank"
                                   class="btn btn-label btn-label-brand btn-sm btn-bold" @click.prevent='signOut'>Sign
                                    Out</a>
...
<script>
    ...
    import CompanyPermissions from '@/mixins/Permissions/CompangConfigurationsPermission'

    export default {
        components: {Languages, Notification},
        mixins: [CompanyPermissions],
        methods: {
            ...mapActions('Auth', ['ResetAuthentication']),
            signOut() {
        ...
        computed: {
            ...mapGetters('Auth', ['getAuth', 'getRoles']),
            user_full_name() {
                return this.getAuth.hasOwnProperty("full_name") ? this.getAuth.full_name : 'Admin'
            }
        }
